...
def _draw_frame(penguin_art, status_line="", progress=0, show_status=False):
    ...
    print(
        f'         {Fore.WHITE}PenguWarp OS  {
            Fore.YELLOW}v0.2.0 "Grape Fruit"{Fore.WHITE}  [Stable]'
    )
    print()
    ...
    S.filesystem.update(
        {
            ...
            "~/sys/version": {
                "type": "file",
                "content": 'PenguWarp OS v0.2.0 "Grape Fruit" Stable\nKernel: v0.2.0-grape-fruit_x86_64',
            },
            # user home
            ...
            f"{user_home}/welcome.txt": {
                "type": "file",
                "content": (
                    f'Welcome to PenguWarp OS "Grape Fruit", {username}!\n\n'
